                                            ...
                                            <form id="update-nav-menu" action="" method="post"
                                                ...
                                                <div class="menu-edit ">
                                                    <div id="nav-menu-header">
                                                        <div class="major-publishing-actions">
                                                            ...
                                                            <div class="publishing-action">
                                                                <button type="button" id="save_menu_header"
                                                                        class="btn btn-dark menu-save" name="save_menu"
                                                                        onclick="getmenus()">Salvar
                                                                </button>
                                                    ...
                                                    <div id="post-body">
                                                        <div id="post-body-content">
                                                            ...
                                                            <div class="drag-instructions post-body-plain">
                                                                <p>
                                                                    Coloque cada item na ordem que preferir. Clique na
                                                                    seta à direita do item para exibir mais opções de
                                                                    configuração.
                                                                </p>
                                                            </div>
                                                                                ...
                                                                                <dt class="menu-item-handle @if($m->link == '#') bg-secondary text-white @endif">
                                                                                    ...
                                                                                    <span class="item-controls">
                                                                                        ...
                                                                                        <a class="item-edit"
                                                                                           id="edit-{{$m->id}}"
                                                                                           title=" "
                                                                                           href="{{ $currentUrl }}?edit-menu-item={{$m->id}}#menu-item-settings-{{$m->id}}"></a>
                                                                                    </span>
                                                                                </dt>
                                                                            </dl>
                                                                                ...
                                                                                <div class="menu-item-actions description-wide submitbox">
                                                                                    @if($m->link == '#')
                                                                                        <a class="item-delete submitdelete deletion"
                                                                                           id="delete-{{$m->id}}"
                                                                                           href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Excluir</a>
                                                                                        <span class="meta-sep hide-if-no-js"> | </span>
                                                                                    @endif
                                                                                    <a class="item-cancel submitcancel hide-if-no-js button-secondary"
                                                                                       id="cancel-{{$m->id}}"
                                                                                       href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Cancelar</a>
                                                                                    <span class="meta-sep hide-if-no-js"> | </span>
                                                                                    <a onclick="updateitem({{$m->id}})"
                                                                                       class="button button-primary updatemenu"
                                                                                       id="update-{{$m->id}}"
                                                                                       href="javascript:void(0)">Atualizar
                                                                                        item</a>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div id="nav-menu-footer">
                                                        <div class="major-publishing-actions">
                                                            <button type="button" id="save_menu_header"
                                                                    class="btn btn-dark menu-save float-right"
                                                                    name="save_menu" onclick="getmenus()">Salvar
                                                            </button>
                                                            <span class="spinner" id="spincustomu2"></span>
                                                        </div>
                                                    </div>
