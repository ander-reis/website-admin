        ...
        <div class="col-6">
            <div class="form-group">
                <div id="div_img" class="img-giz" style="{{ (isset($data)) ? '' : 'display: none;' }}">
                    <img id="img_giz" class="img-fluid rounded giz-img" src="{{ ($data[7]['updated_at'] > $temp->updated_at) ? asset('/storage/revista_giz/' . $data[7]['id'] . '/' . $data[7]['ds_imagem']) : asset('/storage/revista_giz_temp/' . $temp->id . '/' . $temp->ds_imagem) }} " alt="{!! $data[7]['ds_titulo'] !!}">
                </div>
            </div>
        </div>
