    ...
    <section class="mt-3">
        <div class="owl-content">
            <div class="owl-carousel owl-theme pt-3">
                ...
                <div class="item text-center">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                    <a href="#" class="black faixa_size disabled" target="_blank">Salários e<br />reajustes</a>
                </div>
                <div class="item text-center">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                    <a href="#" class="black faixa_size disabled" target="_blank">Convenções e<br />acordos</a>
                </div>
                <div class="item text-center">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                ...
                                <div class="col-12 col-sm-5">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mt-2">
                                            <a href="{{$noticias_temp[7]['ds_link']}}" class="text-link"
                                                target="_blank">
